...
public class GroupingExample3 {
    public static void main(String[] args) {
        ...
        LinkedHashMap<Integer, List<String>> namesMap = names.stream()
        ...
        LinkedHashMap<String, List<Instructor>> mapOnlineCoursesInstructor = Instructors.getAll().stream()
                .collect(Collectors.groupingBy(instructor -> instructor.getYearsOfExperience() > 10 ? "SENIOR" : "JUNIOR"
                        , LinkedHashMap::new, Collectors.filtering(Instructor::isOnlineCourse, Collectors.toList())));
